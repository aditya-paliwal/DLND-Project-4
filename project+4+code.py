...
def process_decoding_input(target_data, target_vocab_to_int, batch_size):
    ...
    """
    # TODO: Implement Function
    ending = tf.strided_slice(target_data, [0, 0], [batch_size, -1], [1, 1]) # not very clear
...
def encoding_layer(rnn_inputs, rnn_size, num_layers, keep_prob):
    ...
    enc_cell = tf.contrib.rnn.MultiRNNCell([lstm_cell] * num_layers)
...
def decoding_layer_train(encoder_state, dec_cell, dec_embed_input, sequence_length, decoding_scope,
    ...
    outputs, _, _ = tf.contrib.seq2seq.dynamic_rnn_decoder(
        dec_cell, decoder, dec_embed_input, sequence_length, scope=decoding_scope)
...
def seq2seq_model(input_data, target_data, keep_prob, batch_size, sequence_length, source_vocab_size, target_vocab_size,
    ...
    # Decoder
    pre_target_data = process_decoding_input(target_data, target_vocab_to_int, batch_size)
    dec_embeddings = tf.Variable(tf.random_uniform([target_vocab_size, dec_embedding_size]))
    dec_embed_input = tf.nn.embedding_lookup(dec_embeddings, pre_target_data)
    
    train_logits, infer_logits = decoding_layer(
        dec_embed_input, dec_embeddings, encoder_state, target_vocab_size, 
